<template>
  ...
  <div class="">
        <div class="flex flex-row justify-around">
            <h1 class="font-bold text-xl">Danh sách bài viết</h1>
            <div class="w-56 bg-gray-200 h-1"></div>
            <button type="button" class="text-white bg-green-400 rounded-lg text-lg p-1">Thêm bài viết +</button>
        </div>
        <div class="  bg-black w-4/5 h-1 mx-auto mt-1"></div>
      <!-- items -->
      <div
        class="grid lg:grid-cols-3 md:grid-cols-1 text-center justify-center gap-8 mx-20 mt-20">
        <div class="col-span-3 lg:col-span-1">
          ...
          <div class="mt-4">
            <button type="button" class="bg-yellow-300 text-lg text-white rounded-lg mx-5 p-2 ">Sửa</button>
            <button type="button" class="bg-red-500 text-lg text-white rounded-lg mx-5 p-2">Xóa</button>
          </div>
        </div>
        <div class="col-span-3 lg:col-span-1">
          <img
          ...
          />
          <h2 class="font-bold mt-4">
            CHÀO THÁNG 3 TƯƠI MỚI VỚI BỘ BA SỮA CHUA TRÁI CÂY TẠI TRUNG NGUYÊN E-COFFEE
          </h2>
          <div class="mt-4">
            <button type="button" class="bg-yellow-300 text-lg text-white rounded-lg mx-5 p-2 ">Sửa</button>
            <button type="button" class="bg-red-500 text-lg text-white rounded-lg mx-5 p-2">Xóa</button>
